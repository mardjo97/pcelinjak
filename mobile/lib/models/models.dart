...
class Apiary extends SyncRecord {
  ...
  factory Apiary.fromMap(Map<String, dynamic> m) => Apiary(
        ...
        dateSynched: m['dateSynched'] != null ? DateTime.tryParse('${m['dateSynched']}') : null,
        dateDeleted: m['dateDeleted'] != null ? DateTime.tryParse('${m['dateDeleted']}') : null,
      );
}
...
class Queen extends SyncRecord {
  ...
  String get periodLabel {
    final from = (activeFrom ?? dateCreated).toLocal().toString().split(' ').first;
  ...
  factory Queen.fromMap(Map<String, dynamic> m) => Queen(
        ...
        activeFrom: m['activeFrom'] != null ? DateTime.tryParse('${m['activeFrom']}') : null,
        activeTo: m['activeTo'] != null ? DateTime.tryParse('${m['activeTo']}') : null,
        active: m['active'] == null ? true : (m['active'] == true || m['active'] == 1),
...
class Harvest extends SyncRecord {
  ...
  factory Harvest.fromMap(Map<String, dynamic> m) => Harvest(
        ...
        collectedAt: m['collectedAt'] != null ? DateTime.tryParse('${m['collectedAt']}') : null,
...
class WorkGroupHive extends SyncRecord {
  ...
  factory WorkGroupHive.fromMap(Map<String, dynamic> m) {
    ...
    final status = (m['membershipStatus'] as String?) ?? (doneFlag ? 'FINISHED' : 'ACTIVE');
    return WorkGroupHive(
      ...
      checkDate: m['checkDate'] != null ? DateTime.tryParse('${m['checkDate']}') : null,
      reminderAt: m['reminderAt'] != null ? DateTime.tryParse('${m['reminderAt']}') : null,
      pastureType: m['pastureType'] as String?,
      locationName: m['locationName'] as String?,
